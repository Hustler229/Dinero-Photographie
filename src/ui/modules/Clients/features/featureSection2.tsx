...
import Image from "next/image";
 const Section2 = () => {
    ...
    return (
        <>
            <div className={clsx(" my-[100px]  bg-secondary p-10 rounded-[10px] backdrop-blur-2xl xl:grid xl:grid-cols-2 xl:gap-10 xl:mx-10 flex flex-col gap-10 justify-between items-center")}>
                <div className={clsx(" xl:flex-row xl:gap-5 xl:items-center xl:justify-between flex flex-col items-center gap-20 justify-center ")}>
                    <div className="flex flex-col gap-10 items-center justify-center">
                        ...
                        <Text variant="body" tag="div" className="text-center">
                            +100 Clients heureux
                        </Text>
                    </div>
                    <div className="flex flex-col gap-10 items-center justify-center">
